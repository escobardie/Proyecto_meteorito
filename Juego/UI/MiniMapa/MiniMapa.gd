...
export var tiempo_visible:float = 10.0 #tiempo en segundos
...
## ATRIBUTOS ONREADY
onready var zona_renderizado:TextureRect = $CuadroMiniMapa/ContenedroIconos/ZonaRenderizadoMiniMapa
onready var icono_player:Sprite = $CuadroMiniMapa/ContenedroIconos/ZonaRenderizadoMiniMapa/IconoPlayer
onready var icono_base_enemiga:Sprite = $CuadroMiniMapa/ContenedroIconos/ZonaRenderizadoMiniMapa/IconoBaseEnemiga
onready var icono_estacion:Sprite = $CuadroMiniMapa/ContenedroIconos/ZonaRenderizadoMiniMapa/IconoEstacion
onready var icono_interceptor:Sprite = $CuadroMiniMapa/ContenedroIconos/ZonaRenderizadoMiniMapa/IcinoInterceptor
onready var icono_rele:Sprite = $CuadroMiniMapa/ContenedroIconos/ZonaRenderizadoMiniMapa/IconoRele
...
func set_esta_visible(hacer_visible:bool) ->void:
	if hacer_visible:
		timer_visible.start(tiempo_visible)
...
func modificar_posicion_icono() -> void:
	for item in items_mini_mapa:
		...
		if zona_renderizado.get_rect().has_point(pos_icono - zona_renderizado.rect_position):
			...
			item_icono.scale = Vector2(0.4, 0.4)
